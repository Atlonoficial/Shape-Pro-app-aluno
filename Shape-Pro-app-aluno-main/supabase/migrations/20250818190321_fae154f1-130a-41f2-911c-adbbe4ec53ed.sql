-- Fix book_appointment function to use same validation logic as list_available_slots_improved
...
begin
  ...
  insert into public.appointments (
    ...
    extensions.uuid_generate_v4(), p_teacher_id, uid, p_scheduled_time, step, 'confirmed', p_type,
