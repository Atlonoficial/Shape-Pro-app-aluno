...
export const useAvailableSlots = () => {
  ...
  const getAvailableSlots = async (
    ...
    try {
      ...
      console.log('🕒 [useAvailableSlots] Iniciando busca:', {
        teacherId,
        dateStr,
        slotMinutes,
      ...
      if (error) {
        console.error('❌ [useAvailableSlots] Erro na RPC:', error);
        throw error;
      }
      
      console.log('✅ [useAvailableSlots] Sucesso:', {
      ...
      console.error('❌ [useAvailableSlots] Erro completo:', error);
