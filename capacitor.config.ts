...
const config: CapacitorConfig = {
  ...
  version: "4.0.4", // ✅ BUILD 77: Sync version
  ios: {
    scheme: "shapepro",
    ...
    // ✅ BUILD 77: Fix build version conflict
    CFBundleVersion: '77',
    ...
    plist: {
      ...
      CFBundleShortVersionString: "4.0.4",
      CFBundleVersion: "77", // ✅ BUILD 77: Sync with Info.plist
      // ---- OneSignal App ID ----
  ...
  android: {
    ...
    versionCode: 77, // ✅ BUILD 77: Sync with build.gradle
    versionName: "4.0.4"
  },
