...
const config: CapacitorConfig = {
  ...
  version: "4.0.5", // ✅ BUILD 78: Sync version
  ios: {
    scheme: "shapepro",
    ...
    // ✅ BUILD 78: Fix build version conflict
    CFBundleVersion: '78',
    ...
    plist: {
      ...
      CFBundleShortVersionString: "4.0.5",
      CFBundleVersion: "78", // ✅ BUILD 78: Sync with Info.plist
      // ---- OneSignal App ID ----
  ...
  android: {
    ...
    versionCode: 78, // ✅ BUILD 78: Sync with build.gradle
    versionName: "4.0.5"
  },
