...
const config: CapacitorConfig = {
  ...
  version: "52", // ✅ BUILD 52: Bottom nav fixo + queries otimizadas + performance
  ...
  ios: {
    ...
    // ✅ BUILD 52: Versões atualizadas para Build 52
    CFBundleVersion: '52',
    ...
    plist: {
      ...
      CFBundleShortVersionString: "4.0.0",
      CFBundleVersion: "52", // ✅ BUILD 52: Bottom nav fixo + queries otimizadas + performance
  ...
  android: {
    ...
    versionCode: 52, // ✅ BUILD 52: Bottom nav fixo + queries otimizadas + performance
    versionName: "4.0.0"
  },
