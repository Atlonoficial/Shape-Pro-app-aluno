...
const config: CapacitorConfig = {
  ...
  version: "4.0.13", // ✅ BUILD 87: Revisão completa e correções finais
  ios: {
    scheme: "shapepro",
    ...
    // ✅ BUILD 87: Revisão completa e correções finais
    CFBundleVersion: '87',
    CFBundleShortVersionString: "4.0.13",
