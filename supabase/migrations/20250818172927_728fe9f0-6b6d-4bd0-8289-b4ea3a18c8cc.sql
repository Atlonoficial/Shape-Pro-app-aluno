-- Fix the list_available_slots_improved function to use minimum_advance_minutes correctly
...
begin
  ...
  -- Calculate minimum booking time based on advance minutes (FIXED)
...
-- Update teacher booking settings to 5 minutes advance notice as configured
