  ...
  LOOP
    ...
    LOOP
      ...
      BEGIN
        ...
        meal_name := COALESCE((meal_record.value->>'name')::TEXT, 
          CASE WHEN meal_index <= 5 THEN meal_type_names[meal_index] ELSE 'Refeição' END);
    ...
    RAISE NOTICE 'Migrado plano % com % refeições', plan_record.id, array_length(new_meal_ids, 1);
