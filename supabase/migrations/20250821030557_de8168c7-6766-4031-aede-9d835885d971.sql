-- Security improvements: Make user_id columns NOT NULL where appropriate and add constraints
...
CREATE INDEX IF NOT EXISTS idx_rate_limit_log_ip_endpoint ON rate_limit_log(ip_address, endpoint, window_start);
